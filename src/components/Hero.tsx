  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        >
          <div className="w-32 h-32 rounded-full bg-linear-to-br from-blue-400 to-blue-600 flex items-center justify-center text-white text-5xl shadow-2xl border-4 border-white/20">
            SB
          </div>
        </motion.div>
        ...
        >
          ...
          <motion.a
            href="https://www.linkedin.com/in/saujan-bindukar-8b165714b/"
            target="_blank"
